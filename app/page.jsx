    ...
    <>
      ...
      <section className="section section--sand" id="plans">
        <div className="wrap">
          ...
          <Reveal delay={0.2} className="includes">
            <span className="eyebrow" style={{ marginBottom: 0 }}>Included in every package</span>
            <ul className="leaf-list includes__grid">
              <li>Access to a free online support group</li>
              <li>Tailored resources based on individual needs</li>
              <li>Free text support throughout the month</li>
              <li>Flexible and responsive care</li>
              <li>A supportive, compassionate therapeutic relationship</li>
            </ul>
          </Reveal>
        </div>
      </section>
      ...
      {/* ---------- BREATHING SIGNATURE ---------- */}
      <section className="section section--sage breathe">
        <div className="wrap">
      ...
      <section className="section section--ink">
        <div className="wrap split">
          <div>
            ...
            <Reveal delay={0.06}>
              <h2>I-CBT — therapy that targets <span className="accent-i" style={{ color: "var(--blush)" }}>the doubt itself</span></h2>
            </Reveal>
            <Reveal delay={0.12}>
              <p className="lede" style={{ marginTop: "1.2rem" }}>
